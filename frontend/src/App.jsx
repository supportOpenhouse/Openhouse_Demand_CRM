...
import UpcomingVisitsView from './views/UpcomingVisitsView.jsx';
...
const SEARCH_VIEWS = new Set(['visits', 'pipeline', 'upcoming', 'cps', 'properties']);
...
const NAV = [
  ...
  { k: 'upcoming',      icon: '📆', label: 'Upcoming Visits' },
  ...
  { k: 'salesmanagers', icon: '🧑‍💼', label: 'Sales Managers', adm: true },
      ...
      <div className="rx-shell">
        ...
        <header className="rx-topbar">
          ...
          <div className="rx-topbar-right">
            ...
            {(view === 'visits' || view === 'pipeline' || view === 'upcoming') && (
          ...
          <main className="rx-main">
            <div key={view} className="rx-view">
              ...
              {isReportViewer && view === 'register-cp' ? (
                ...
                <UpcomingVisitsView seed={vseed} onOpenBroker={setOpenCp} reloadSeed={reloadSeed} search={search} filters={filters} onResetSearch={resetSearch} onResetGlobalFilters={resetGlobalFilters} />
              ) : view === 'pipeline' ? (
                ...
                isAdmTL ? <SalesManagersView seed={seed} /> : <div className="empty"><div className="emoji">🚧</div><div className="t">Coming soon</div></div>
              ) : view === 'register-cp' ? (
                <RegisterCpView />
              ) : view === 'team' ? (
